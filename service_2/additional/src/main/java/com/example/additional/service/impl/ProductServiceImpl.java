...
public class ProductServiceImpl implements ProductService {
    ...
    public List<ProductDto> getAllProductsManufacture(String manufacturerId) {
        List<ProductDto> response = List.of(Objects.requireNonNull(this.restTemplate.getForObject("http://basic/api/v1/products", ProductDto[].class)));
    ...
    public void reducePriceAllProductsByPercentage(Integer decreasePercent) {
        ...
        List<ProductDto> allProduct = List.of(Objects.requireNonNull(this.restTemplate.getForObject("http://basic/api/v1/products", ProductDto[].class)));
        for (ProductDto productResponseDto : allProduct) {
            ...
            this.restTemplate.put("http://basic/api/v1/products/{id}", productResponseDto, urlParams);
        }
    }
}
